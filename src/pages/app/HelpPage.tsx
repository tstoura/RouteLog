...
const sections: HelpSection[] = [
  ...
  },
  {
    ...
    body: 'Οι βαθμοί εμφανίζονται μόνο σε επίσημες καταγραφές, όταν έχουν συμπληρωθεί τα απαραίτητα πεδία. Ο υπολογισμός γίνεται από το backend της εφαρμογής, ώστε οι τελικοί βαθμοί να συμφωνούν με την αποθηκευμένη καταγραφή.',
  },
  {
    icon: <Mountain className="size-5 shrink-0 text-[#00453e]" strokeWidth={1.8} aria-hidden />,
    title: 'Τι είναι οι αναρριχητικές διαδρομές;',
    body: 'Στην ενότητα «Διαδρομές» μπορείτε να δείτε διαθέσιμες αναρριχητικές διαδρομές, πληροφορίες για το πεδίο και σχόλια ή αξιολογήσεις χρηστών.',
  },
  {
